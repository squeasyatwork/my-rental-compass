    ...
    >
      <div className="flex flex-col md:flex-row items-center justify-center w-full">
        ...
        <div className="flex flex-col text-3xl ml-6 w-full md:max-w-2xl">
          <h2>
            Finding a livable home at an affordable rent in Melbourne can be
      ...
      <div className="flex items-center justify-center flex-wrap w-full mt-8 md:mt-24">
        ...
        <div className="mx-4 px-6 relative">
          <input
            type="text"
            className="text-2xl font-bold p-4 rounded border-4 border-yellow-500 w-full text-center"
            placeholder="$400"
