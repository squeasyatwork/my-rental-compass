  ...
  return (
    <>
      ...
      <main className="font-istok flex flex-col min-h-screen text-black justify-start w-full h-full bg-white">
        ...
        <div className=" flex justify-center items-center font-bold text-5xl text-HeadingTextGray mt-8 px-6">
          <h1>{t("common:icons_credits_section_heading")}</h1>
        </div>
        <div className="flex flex-col  justify-center items-center p-6 ">
          <div className="flex flex-col items-start justify-center space-y-4">
            <div className="flex flex-col">
              <h2 className=" text-xl font-bold"> {t("dict2:credits_page_home")}</h2>
              <a href="https://www.rmit.edu.au/research/our-research/enabling-impact-platforms/case-studies/planning-liveable-cities" class="text-HeadingTextGrey font-istok hover:underline ">● https://www.rmit.edu.au/research/our-research/enabling-impact-platforms/case-studies/planning-liveable-cities</a>
              <a href="https://www.flaticon.com/free-icons/home" class="text-HeadingTextGrey font-istok hover:underline ">● https://www.flaticon.com/free-icons/home</a>
              <a href="https://www.flaticon.com/free-icons/house" class="text-HeadingTextGrey font-istok hover:underline ">● https://www.freepik.com/free-photo/kitchen-student-dormitory-group-interracial-students-engaged-education_29719888.htm Image by fxquadro on Freepik</a>
              <a href="https://www.flaticon.com/free-icon/agreement_2838110?term=agreement&page=1&position=3&origin=search&related_id=2838110" class="text-HeadingTextGrey font-istok hover:underline ">● https://www.flaticon.com/free-icons/home Home icons created by Freepik - Flaticon </a>
              <a href="https://www.flaticon.com/free-icons/playground" class="text-HeadingTextGrey font-istok hover:underline ">● https://www.flaticon.com/free-icons/playground Playground icons created by Bamicon - Flaticon </a>
            </div>
            <div className="flex flex-col">
              <h2 className="text-xl font-bold"> {t("dict2:credits_page_questionnaire")}</h2>
              <a href="https://www.flaticon.com/free-icons/university" class="text-HeadingTextGrey font-istok hover:underline ">● https://www.flaticon.com/free-icons/university</a>
              <a href="https://www.flaticon.com/free-icons/landscape" class="text-HeadingTextGrey font-istok hover:underline ">● https://www.flaticon.com/free-icons/landscape </a>
            </div>
            <div className="flex flex-col">
              <h2 className="text-xl font-bold">{t("dict2:credits_page_wyntd")}</h2>
            ...
            <div className="flex flex-col">
              <h2 className="text-xl font-bold">{t("dict2:credits_page_wyntk")}</h2>
              <a href="https://www.flaticon.com/free-icon/agreement_2838110?term=agreement&page=1&position=3&origin=search&related_id=2838110" className="text-HeadingTextGrey font-istok hover:underline">● https://www.flaticon.com/free-icon/agreement_2838110?term=agreement&page=1&position=3&origin=search&related_id=2838110</a>
              <a href="https://www.flaticon.com/free-icon/interior-design_2400629?term=interior+design&related_id=2400629" className="text-HeadingTextGrey font-istok hover:underline">● https://www.flaticon.com/free-icon/interior-design_2400629?term=interior+design&related_id=2400629</a>
            ...
            <div className="flex flex-col">
              <h2 className="text-xl font-bold">{t("dict2:credits_page_privacy")}</h2>
            ...
            <div className="flex flex-col">
              <h2 className="text-xl font-bold">{t("dict2:credits_page_credits")}</h2>
